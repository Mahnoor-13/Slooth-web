          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <img className="pet-modal" src={require("./assets/pet5.jpg")}/>
                <div>
                ...
                <div className="bottom-right-modal"  onClick={()=>this.props.petprofile5()}><i className="fa fa-arrow-right" aria-hidden="true"></i>
                </div>
              </div>
            </div>
          </div>
