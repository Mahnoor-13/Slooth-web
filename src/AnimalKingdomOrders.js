        ...
        <div className="main">
          ...
          <div className="sloothAlertcenter1">
            ...
            >
              <div
                className="topTabs"
                onClick={() => this.setState({ tab: "cafelist" })}
                style={
                  this.state.tab === "cafelist" ? { background: "#4a4c99" } : {}
                }
              >
                <div
                  style={
                    this.state.tab === "cafelist"
                      ? { color: "white" }
                      : { color: "#2a2c7c" }
                  }
                //   topTabs {
              ...
              <div
                ...
                style={
                  this.state.tab === "orders" ? { background: "#4a4c99" } : {}
                }
              >
                <div
                  style={
            ...
            {this.state.tab === "orders" ? (
              ...
              >
                <div
                  ...
                  style={
                    this.state.type === "cart" ? { background: "#4a4c99" } : {}
                  }
                >
                  <div
                    style={
                ...
                <div
                  className="citems"
                  onClick={() => this.setState({ type: "activeorders" })}
                  style={
                    this.state.type === "activeorders"
                      ? { background: "#4a4c99" }
                      : {}
                  }
                >
                ...
                <div
                  className="citems"
                  onClick={() => this.setState({ type: "completedorders" })}
                  style={
                    this.state.type === "completedorders"
                      ? { background: "#4a4c99" }
                      : {}
                  }
                >
            ...
            {this.state.type === "cart" ? (
              ...
              <img style={{width:"20%"}} src={require("./assets/cart.png")} />
              <div>$12</div>
           </div>
            ) : (
              <div className="slooth-dashed-kingdom text-center">
                <button
                  type="button"
                  className="para-alert-kingdom btn"
                  onClick={() => this.props.history.push("/animalKingdomCafe")}
                >
                  ADD NEW PRODUCT
                </button>
              </div>
...
<div className="slooth-dashed-kingdom text-center">
            ...
            <div class="card text-center">
              <div class="card-header">
                <div style={{ color: "#2a2c7c" }}>Created: 21/4/2020 19:00</div>
              </div>
              <div class="card-body">
                <h5 class="card-title">Order Details</h5>
                <h6 class="card-title">Order No: 00000000002</h6>
                <div className="orderitems">
                  <div>
                    <p class="card-text">Pet material 1kg</p>
                  </div>
                  <div>$12</div>
                </div>
                ...
                <div className="orderitems">
                  <div>
                    <p class="card-text">cleaning shamp 4kg</p>
                  </div>
                  <div>$2</div>
                </div>
            ...
            <div class="card text-center">
              <div class="card-header" style={{
                ...
                <div style={{ color: "#2a2c7c" }}>Created: 20/4/2020 19:00</div>
                <div style={{ color: "#2a2c7c" }}>Completed: 21/4/2020 19:00</div>
              </div>
              <div class="card-body">
                <h5 class="card-title">Order Details</h5>
                <h6 class="card-title">Order No: 00000000001</h6>
                <div className="orderitems">
                  <div>
                    <p class="card-text">Milk for pet 3kg</p>
                  </div>
                  <div>$52</div>
                </div>
                ...
                <div className="orderitems">
                  <div>
                    <p class="card-text">Soaps and shamp 3kg</p>
                  </div>
                  <div>$112</div>
                </div>
