      ...
      <div className="main">
        ...
        <div className="story-center">
          ...
          <div className="sto-main">
            ...
            {/* <div className="all-story" onClick={()=>setSelectedStories(stories3,"../../assets/story.jpeg", "sdnasfjdnfu")}>
              <div className="story-width">
                <img
                  className="story-pet"
                  src={require("../../assets/story.jpeg")}
                />
              </div>
              <div className="name-story">
                <p className="name-story">
                  sdnasfjdnfu <span className="story-hello">@Askbrih</span>
                </p>
                <p className="story-hello">Hello</p>
              </div>
              <div className="story-now">3m</div>
        ...
        <StorisSmallComponents stories2={selectedStories} />
